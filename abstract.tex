...
to micro-architectural optimizations such as pipelining, super-scalar and
out-of-order execution, and micro-op fusion.
...
cost models in production compilers such as LLVM
and in vendor supplied machine code analyzers such as Intel's IACA.
...
Our benchmark suite contains more than 300,000 
...
ranges from crashing to obtaining results that are orders of magnitude away from the ground truth.
We analyze the benchmark suite and show how and where popular
cost models such as llvm-mca, IACA, Ithemal and
OSACA deviate from the measured throughput.
