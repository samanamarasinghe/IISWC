...
%The quality of a cost model is often overlooked compared to the implementation of an optimization,despite the fact that the accuracy of the former ensures the effectiveness of the latter.
